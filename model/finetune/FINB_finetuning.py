...
class FINBFinetuning():
    ...
    def meta_finetuning(self, data, sou_data, config):
        ...
        self.prototypical_feature_reprojection_stage1(support, sou_support, epoch, m_inter, m_target)
        self.Instance_level_feature_recalibration(support, data)
        self.prototypical_feature_reprojection_stage2(support, epoch)

    def prototypical_feature_reprojection_stage1(self, support, sou_support, epoch, m_inter, m_target):
